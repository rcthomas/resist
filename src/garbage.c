...
void initialize(struct support_t* support,
        real min_wl, real max_wl, real bin_step
        real min_v, real max_v, real v_step,
        num_angles) {
...
void execute(struct support_t* support, struct setup_t* setup) {
...
int resist_mini(int argc, char* argv[]) {
